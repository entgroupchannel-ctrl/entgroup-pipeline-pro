  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">ลองรีเฟรชหรือกลับหน้าหลัก</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ENTGROUP CRM" },
      { name: "description", content: "ระบบจัดการลูกค้าและ Pipeline สำหรับทีมขาย ENTGROUP" },
      { property: "og:title", content: "ENTGROUP CRM" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai:wght@300;400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap" },
    ],
  }),
